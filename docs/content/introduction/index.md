---
title: Introduction
description: What is Regle and why choose it for Vue form validation
---
...
::tip
Coming from Vuelidate? Regle's API is intentionally similar to Vuelidate's. Check out our [comparison guide](/introduction/comparisons#vuelidate) to see what's changed and what's stayed the same.
::