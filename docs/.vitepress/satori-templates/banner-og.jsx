...
>
  ...
  >
    ...
    <span style={{ fontSize: 36, color: '#fff' }}>Headless form validation for Vue.js</span>
    <span style={{ fontSize: 16, marginTop: '10px', fontWeight: 'normal', color: '#ddd' }}>
      Typescript first, model-based and intuitive API. The perfect evolution of Vuelidate.
    </span>
  </div>
</div>;
