...
>
  ...
  <svg width={230} height={230} style={{position: "absolute", top: '60%', transform: "translate(0%, -50%)"}} viewBox="0 0 501 501">
      <g>
        <path
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="900" style={{top: "-30px",left: "-200px", opacity:"0.7", zIndex: "-1"}} height="500">
      <defs>
