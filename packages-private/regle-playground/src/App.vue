  ...
  if (!hash) {
    store.setImportMap({
      imports: {
        ...
        '@vue/devtools-api': 'https://cdn.jsdelivr.net/npm/@vue/devtools-api@8.2.1/+esm',
        '@vue/devtools-kit': 'https://cdn.jsdelivr.net/npm/@vue/devtools-kit@8.2.1/+esm',
        ...
        zod: 'https://cdn.jsdelivr.net/npm/zod@latest/+esm',
        valibot: 'https://cdn.jsdelivr.net/npm/valibot@latest/+esm',
      },
    });
